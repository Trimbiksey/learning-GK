		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-12 col-md-5">
					<div class="main-img wow jackInTheBox hidden-mobile">
						<img src="img/main/main-img.png" alt="короба">
					</div>
	...
	<section class="features" id="features">
		<div class="container ">
			...
			<div class="features-blocks">
				...
				<div class="features-block wow fadeInDown" data-wow-delay="0.1s">
				...
				<div class="features-block wow fadeInDown" data-wow-delay="0.2s">
					<div class="features-block__img">
				...
				<div class="features-block wow fadeInDown" data-wow-delay="0.3s">
					<div class="features-block__img">
				...
				<div class="features-block wow fadeInUp" data-wow-delay="0.6s">
					<div class="features-block__img">
						<img src="img/features/Layer_13.png" alt="Гидрофобные добавки">
					</div>
					<!-- /.features-block__img -->
					<div class="features-block__text">
						<div class="features-block__title">
